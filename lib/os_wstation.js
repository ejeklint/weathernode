...
//    publish_key: "pub-9b4a2d56-ba27-4852-8a89-0e9c3bef506d",
//    subscribe_key: "sub-724481b0-7a6e-11e1-86aa-3d02e4f11706",
//    secret_key: "sec-1ce6ba27-797c-4cce-a33b-6488d4d260e5"
//});
//
...
function OS_WStation(dataLogger) {
    ...
    if (nconf.get('pachube')) {
        var PachubeLogger = require('./pachube_logger');
        self.dataLogger = new PachubeLogger();
    }
    if (nconf.get('pusher')) {
        var PachubeLogger = require('./pusher_logger');
        self.pusherLogger = new PachubeLogger();
    }
